...
let ContactPage = class ContactPage {
    ...
    save() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            const ct_namealert = yield this.alertController.create({
                message: 'Please enter name',
                buttons: ['OK']
            });
            const ct_emailalert = yield this.alertController.create({
                message: 'Please enter email',
                buttons: ['OK']
            });
            const ct_phonealert = yield this.alertController.create({
                message: 'Please enter phone',
                buttons: ['OK']
            });
            const ct_subjectalert = yield this.alertController.create({
