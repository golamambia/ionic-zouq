  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["checkout-checkout-module"], {
    ...
    function srcAppCheckoutCheckoutPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var CheckoutPage = /*#__PURE__*/function () {
        function CheckoutPage(http, navCtrl, storage, loadingController, alertController, toastController) {
          var _this = this;
        ...
        _createClass(CheckoutPage, [{
          ...
          value: function onChangeHandler($event) {
            ...
            this.paymentmode = $event.target.value; //console.log(this.paymentmode);
          }
        }, {
          key: "onChangeHandler2",
          value: function onChangeHandler2($event) {
            this.dtime.paytyp = $event.target.value;
            this.pickup_delivery = $event.target.value; //console.log(this.paymentmode);
          }
        }, {
          key: "onChangeHandler3",
          value: function onChangeHandler3($event) {//console.log(this.use_voucher);
          }
        }, {
          ...
          value: function listing() {
            ...
            this.storage.get("userDetails").then(function (val) {
              if (val) {
                ...
                _this4.http.post(_this4.appUrl + '/' + _this4.userDetails.user_id, {
                  data: ''
                }, {
                  headers: headers
                  ...
                  _this4.voucher_amt = _this4.res.voucher_amount;

                  if (_this4.res.addresses) {
                    _this4.address_list = _this4.res.addresses;
          ...
          key: "selectDeliveryAddress",
          value: function selectDeliveryAddress(idx) {
          ...
          value: function book_order() {
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
              ...
              var loading, alert, addrsalert, useralert, paymodealert, deldatealert, timealert, headers, data;
              return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    ...
                    case 33:
                      if (!(this.pickup_delivery == 'later' && this.uba_delivery_date2 == null)) {
                        _context.next = 38;
                        break;
                      }
                    ...
                    case 38:
                      if (!(this.pickup_delivery == 'later' && this.uba_delivery_time2 == null)) {
                        _context.next = 43;
                        break;
                      }
                    ...
                    case 43:
                      if (!(this.use_voucher != '' && this.voucher_amt < this.cartTotalAmount && (this.paymentmode == '' || this.paymentmode == null))) {
                        _context.next = 48;
                        break;
                      }
                    ...
                    case 48:
                      if (!(this.use_voucher == '' && (this.paymentmode == '' || this.paymentmode == null))) {
                        _context.next = 53;
                        break;
                      }
