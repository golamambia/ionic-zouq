  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["profile-profile-module"], {
    ...
    function srcAppProfileProfilePageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var ProfilePage = /*#__PURE__*/function () {
        function ProfilePage(http, navCtrl, storage, loadingController, alertController, location) {
          var _this = this;
        ...
        _createClass(ProfilePage, [{
          ...
          value: function updateProfile() {
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
              ...
              var loading, namealrt, phonealrt, erroralrt, successalrt, headers, data;
                  ...
                  switch (_context.prev = _context.next) {
                    ...
                    case 28:
                      data = {
                        ...
                        "phone": this.phone,
                        "action": 'updateProfile' //"photo": this.photo
                      ...
                      this.http.post(this.appUpdate, JSON.stringify(data), {
                        ...
                        if (_this2.res.status == 0) {
                          ...
                          _this2.htmlYouWantToAdd = _this2.name; //this.navCtrl.navigateForward('login');
